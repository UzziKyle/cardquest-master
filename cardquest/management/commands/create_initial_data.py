...
class Command(BaseCommand):
    ...
    def create_trainers(self):
        ...
        trainer9 = Trainer(name="Uzzi",birthdate= "2002-08-24",location= "Palawan",email= "uzzi@pokemon.com")
        trainer10 = Trainer(name="Kyle" ,birthdate= "2002-08-24" ,location= "Bulacan" ,email= "kyle@pokemon.com")
